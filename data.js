...
var initialStickyNotes = [
  ...
  },
  {
    ...
    roleName: "👨‍👦 家长寄语",
    color: "blue",
    content: "特别认同陈昨说的‘画画是情绪的释放’。子墨以前性格内向，现在每次上完美术课回到家都特别兴奋，拉着我们讲画里的小怪兽。艺术真的能打开孩子的心灵。",
    tag: "#情绪释放与自信",
    date: "2026.08.14",
    likes: 19,
    isLiked: false
  ...
  },
  {
    ...
    roleName: "🌟 艺术爱好者",
    color: "pink",
    content: "偶然刷到这个儿童画廊，被孩子们的色彩冲击到了！没有模板化范画的匠气，全是原生的当代艺术触觉。国内的美育太需要这样呵护孩子天性的土壤了，为陈昨点赞！",
    tag: "#当代少儿美育实践",
    date: "2026.08.12",
    likes: 42,
    isLiked: false
  ...
  },
  {
    ...
    roleName: "👩‍👧 家长寄语",
    color: "blue",
    content: "每一堂课孩子都在发光！感谢陈昨用爱呵护孩子的艺术天赋 💖",
    tag: "#给陈昨点赞",
    date: "2026.08.08",
    likes: 33,
    isLiked: false
